...
use App\GeoData\Exceptions\CountryNotAvailableException;
use App\GeoData\Exceptions\CountryAlreadyInstalledException;
...
class CountryInstaller
{
     ...
     * @throws App\GeoData\Exceptions\CountryNotAvailableException
     * @return void
     */
     ...
     * Install country.
     *
     * @throws App\GeoData\Exceptions\CountryAlreadyInstalledException
     * @return void
     */
    public function install()
    {
        ...
        DB::transaction(function() use ($country)
        {
            Artisan::call('db:seed', [
                '--class' => 'App\GeoData\Seeders\\'.$this->getSeederName($country),
                '--force' => true,
            ]);
        });
    }
    ...
    {
        $seeder = 'App\GeoData\Seeders\\'.self::getSeederName($country);
        return new $seeder();
    }
}